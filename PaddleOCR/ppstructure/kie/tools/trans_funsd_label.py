...
def main():
    test_image_dir = "train_data/XFUND/labeling_data/XAI"
    test_anno_dir = "train_data/XFUND/test/"
    test_output_dir = "train_data/XFUND/finalt.json"
    ...
    train_image_dir = "train_data/XFUND/labeling_data/XAI"
    train_anno_dir = "train_data/XFUND/normalize_eval.json"
    train_output_dir = "train_data/XFUND/finaltrain.json"
